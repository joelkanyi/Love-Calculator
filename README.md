...
A simple app that consumes Rapid API's [Love Calculator API](https://rapidapi.com/ajith/api/love-calculator) to give love percentage between two lovers plus a free advise. Built with clean architecture principles.
